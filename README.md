...
- 📚 Developed as part of **First-Year Engineering coursework & group projects**.  
...
## 📌 Future Scope  
- Enhance **Smart Lock System** with biometric authentication (fingerprint, RFID).  
- Improve **AI Text Detector** with deep learning models (e.g., Transformers).  
- Extend **Landmark Detection** to multi-landmark datasets with higher accuracy.  
